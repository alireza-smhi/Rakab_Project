...
private:
    ...
    vector <PurpleCard*> allPurpleCardsForFinalCalculate;
...
public:
    ...
    //------------------------------------------------------------------------------------------------------
    vector <PurpleCard*> putAllPurpleCardsInOneVector(vector <vector <PurpleCard*>> purpleCards) {
    ...
    void CalculatePoints(vector <Player> &p) {
        ...
        for (int i = 0; i < pointsEarned.size(); i++) {
            ...
            for (int j = 0; j < purpleCards[i].size(); j++) {
                purpleCards[i][j] -> makeEffect(*this, p, i);
            }
